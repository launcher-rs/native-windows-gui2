...
impl EventData {
    ...
    pub fn on_tree_view_end_item_edit(&self) -> (bool, String) {
        match self {
            EventData::OnTreeViewEndItemEdit { f_cancel, new_text } => {
                (*f_cancel, new_text.to_string())
            }
            d => panic!("Wrong data type: {:?}", d),
        }
    }
    ...
    pub fn on_list_view_item_changed(&self) -> (usize, usize, bool) {
        match self {
            &EventData::OnListViewItemChanged {
                ...
                column_index,
                selected,
            } => (row_index, column_index, selected),
            d => panic!("Wrong data type: {:?}", d),
        }
    }
}
    ...
    pub fn files(&self) -> Vec<String> {
        ...
        unsafe {
            for i in 0..len {
                ...
                let buffer_size =
                    (DragQueryFileW(self.drop, i as _, ptr::null_mut(), 0) + 1) as usize;
...
impl MinMaxInfo {
    ...
    pub fn set_maximized_size(&self, width: i32, height: i32) {
        ...
        let (x, y) = crate::win32::high_dpi::logical_to_physical(width as i32, height as i32);
    ...
    pub fn maximized_size(&self) -> [i32; 2] {
        let info = unsafe { &mut *self.inner };
        let (w, h) =
            crate::win32::high_dpi::physical_to_logical(info.ptMaxSize.x, info.ptMaxSize.y);
        [w, h]
    }
    ...
    pub fn set_maximized_pos(&self, x: i32, y: i32) {
        let info = unsafe { &mut *self.inner };
        let (x, y) = crate::win32::high_dpi::logical_to_physical(x, y);
    ...
    pub fn maximized_pos(&self) -> [i32; 2] {
        let info = unsafe { &mut *self.inner };
        let (x, y) =
            crate::win32::high_dpi::physical_to_logical(info.ptMaxPosition.x, info.ptMaxPosition.y);
    ...
    pub fn set_max_size(&self, width: i32, height: i32) {
        let info = unsafe { &mut *self.inner };
        let (x, y) = crate::win32::high_dpi::logical_to_physical(width, height);
    ...
    pub fn max_size(&self) -> [i32; 2] {
        let info = unsafe { &mut *self.inner };
        let (w, h) = crate::win32::high_dpi::physical_to_logical(
